...
//        tvConfirm = (TextView) findViewById(R.id.tv_confirm);
        ...
        if (isSettingHeader){
            ibConfirm.setImageResource(R.drawable.icon_confirm);
        }
    }
...
//            Toast.makeText(PreviewActivity.this, R.string.choice_img,Toast.LENGTH_SHORT).show();
