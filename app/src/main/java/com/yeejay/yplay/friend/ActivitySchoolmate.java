...
//
//public class ActivitySchoolmate extends BaseActivity {
//
...
//        StatuBarUtil.setMiuiStatusBarDarkMode(ActivitySchoolmate.this,true);
//
...
//        recommendsMap.put("uin", SharePreferenceUtil.get(ActivitySchoolmate.this, YPlayConstant.YPLAY_UIN, 0));
//        recommendsMap.put("token", SharePreferenceUtil.get(ActivitySchoolmate.this, YPlayConstant.YPLAY_TOKEN, "yplay"));
...
//                            initSchoolmateListView(mDataList);
//                        }
...
//                        System.out.println("同校好友异常---" + e.getMessage());
//                        aafdPtfRefresh.finishLoadMore();
//                    }
//
//                    @Override
